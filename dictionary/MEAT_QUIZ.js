...
window.MEAT_QUIZ = [
  {
    ...
    "hint": "Тот же отруб, что и у знаменитого стейка имени большого города, но целиком — для духовки, а не для сковороды. Часть туши: поясничная часть спины (тонкий край, сразу за рёбрами).",
    "comment": "Целый отруб тонкого края (стриплойна) для запекания. Готовится в духовке целиком: обжарка корочки при высокой температуре, затем доведение при 120–150°C до внутренней температуры 52–57°C, обязательный отдых 15–20 минут. В отличие от стейка Нью-Йорк это не порционный кусок, а жаркое на несколько человек; в отличие от рибай-ростбифа мясо плотнее и постнее, без крупного жирового «глазка».\n\nПоставка и разделка на кухне:\nНа кухню чаще всего приходит не порционными стейками, а целым бескостным стриплойном (отруб тонкого края, 4–6 кг в вакууме). Пила не нужна — всё режется ножом:\n• зачистить лишний жир, оставив полоску 0,5–1 см по краю;\n• нарезка поперёк волокон: 2,5–3 см — классический стейк Нью-Йорк; 4–5 см — Steakhouse Cut; 0,5–1 см — Thin-Sliced для сэндвичей;\n• отруб целиком, без нарезки — это New York Strip Roast;\n• неровные концы и обрезки — полосками на стир-фрай или в фарш."
  },
  {
    ...
    "hint": "Порционный стейк, названный в честь города, который никогда не спит; жирная кромка у него только с одной стороны. Часть туши: поясничная часть спины (тонкий край, сразу за рёбрами).",
  ...
  },
  {
    ...
    "hint": "Очень толстая версия «городского» стейка — такую подают в дорогих мясных ресторанах и готовят методом обратной обжарки. Часть туши: поясничная часть спины (тонкий край, сразу за рёбрами).",
  ...
  },
  {
    ...
    "hint": "«Городской» стейк, раскатанный почти в лист бумаги — на сковороде проводит меньше времени, чем вы читаете эту подсказку. Часть туши: поясничная часть спины (тонкий край, сразу за рёбрами).",
  ...
  },
  {
    ...
    "hint": "Король стейков на кости: по одну сторону кости — один знаменитый стейк, по другую — второй, и оба размером «на двоих». Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
    "comment": "Большой стейк на Т-образной кости, объединяющий два мяса: тонкий край (стриплойн) с одной стороны кости и крупный кусок вырезки с другой. Жарится на гриле по 4–5 минут на сторону, вырезку держат дальше от сильного жара, чтобы не пересушить. От ти-боуна отличается размером вырезки: у портерхауса её диаметр не менее 32 мм — фактически это «два стейка в одном».\n\nПоставка и разделка на кухне:\nПриходит целая короткая поясница (short loin) НА КОСТИ — единый кусок с позвоночником, который режется только ленточной пилой, поперёк:\n• толщина реза 2–2,5 см — обычные стейки; 4–5 см — Steakhouse Cut; ~1 см — Thin-Sliced;\n• резы с переднего (рёберного) конца, где вырезка узкая (меньше 32 мм), — это T-Bone;\n• резы с заднего конца, где вырезка широкая, — Porterhouse;\n• если не пилить, а разобрать ножом: сверху кости снимется бескостный стриплойн (стейки Нью-Йорк), снизу — вырезка (шатобриан, филе-миньон)."
  },
  {
    ...
    "hint": "Огромная «двойная» версия стейка на Т-кости — во Флоренции похожий кусок считают национальным достоянием. Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
  ...
  },
  {
    ...
    "hint": "Тонкий, как блин, но всё с той же знаменитой костью в форме буквы алфавита и двумя видами мяса по бокам. Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
  ...
  },
  {
    ...
    "hint": "Назван в честь буквы алфавита, которую образует его кость; у его «старшего брата» кусок вырезки крупнее. Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
  ...
  },
  {
    ...
    "hint": "Утолщённая ресторанная версия стейка с «буквенной» костью и маленьким кусочком самого нежного мяса сбоку. Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
  ...
  },
  {
    ...
    "hint": "Кость в форме буквы есть, а вот толщины почти нет — готовится быстрее яичницы. Часть туши: короткая поясница — стык тонкого края и вырезки, с позвоночной костью.",
  ...
  },
  {
    ...
    "hint": "Праздничное жаркое, которое запекают «стоя» на собственных костях — на Рождество в США оно главный герой стола. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
    "comment": "Рёберное жаркое на костях, он же прайм-риб — праздничное блюдо американской кухни. Запекается «стоя» на рёбрах, которые служат естественной подставкой: сначала 220°C для корочки, затем 120–150°C до 52–55°C внутри, отдых 20–30 минут. Отличается от бескостного рибай-ростбифа наличием рёберных костей, которые дают дополнительный вкус, а от стейка рибай — тем, что это целый отруб на несколько рёбер, а не порционный кусок.\n\nПоставка и разделка на кухне:\nПриходит целый рёберный отруб на семи рёбрах (рёбра 6–12, ~7–9 кг):\n• целиком, перевязанный шпагатом, — Standing Rib Roast (прайм-риб);\n• пила поперёк, по одному ребру на кусок (4–6 см), — Bone-In Ribeye («ковбой»);\n• срезать рёбра одним пластом вдоль костей — получится бескостный Ribeye Roast, а сами кости после зачистки — Beef Back Ribs;\n• бескостная часть режется ножом: 2,5–3 см — рибай-стейк; 4–5 см — Steakhouse Cut; 0,5–1 см — Thin-Sliced для чизстейков."
  },
  {
    ...
    "hint": "Самый мраморный из классических стейков, но с «ручкой» из кости — в удлинённой версии его сравнивают с индейским оружием. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Гигантская ресторанная версия самого «жирного» классического стейка, да ещё и с костью — одному такой не осилить. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Мраморный «глазок» и косточка на месте, но толщина — почти как у бекона. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Эти кости «отдали» почти всё мясо знаменитому мраморному стейку, а сами стали классикой барбекю-коптилен. Часть туши: спинные рёбра — кости рёберной части после снятия рибая.",
  ...
  },
  {
    ...
    "hint": "Праздничное жаркое из самого мраморного отруба, но кости уже удалили — нарезать сможет даже новичок. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Его название буквально описывает жировой «глаз» в центре куска; считается самым сочным из классической четвёрки стейков. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Очень толстая версия «глазастого» мраморного стейка — жарить его в лоб нельзя, нужна обратная обжарка. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "Любимая нарезка для знаменитого сэндвича из Филадельфии — мраморное мясо, тонкое, как лепесток. Часть туши: рёберная (спинная) часть, рёбра 6–12.",
  ...
  },
  {
    ...
    "hint": "«Народный» стейк: недорогой, постный и вкусный, но ошибок в прожарке не прощает — жира в нём почти нет. Часть туши: кострец — верх крестцовой части, за поясницей.",
    "comment": "Стейк из верхней части сирлойна (кострец) — постный, ароматный и доступный по цене. Жарится на гриле 3–4 минуты на сторону строго до medium rare; из-за малого количества жира пережаривание делает его сухим, полезно предварительное маринование. От рибая отличается почти полным отсутствием мраморности, от стейков из round (задней ноги) — заметно большей мягкостью при похожей постности.\n\nПоставка и разделка на кухне:\nПриходит целый верх костреца (top sirloin butt, 4–5 кг в вакууме), пила не нужна:\n• первым делом по естественному шву снимается «шапка» с жировым слоем — это Sirloin Cap (пиканья);\n• из округлого центра режут медальоны 4–5 см — Sirloin Fillet (при желании — в бекон);\n• остальной массив: 2,5 см — Top Sirloin Steak, ~1 см — Thin-Sliced;\n• обрезки — кубиками 3–4 см для кебабов или полосками 5×1 см для стир-фрая."
  },
  {
    ...
    "hint": "Тонкая версия «народного» постного стейка из костреца — минута на сторону, и на стол. Часть туши: кострец — верх крестцовой части, за поясницей.",
  ...
  },
  {
    ...
    "hint": "Гордость бразильских грилей: узнать его можно по толстой жировой «шапке» с одной стороны куска. Часть туши: самая «шапка» костреца, верхний его слой с жировой крышкой.",
  ...
  },
  {
    ...
    "hint": "Выглядит как знаменитый «миньон», стоит в разы дешевле, но вырезкой при этом не является. Часть туши: кострец — верх крестцовой части, за поясницей.",
  ...
  },
  {
    ...
    "hint": "Высокий «бочонок» постного мяса, притворяющийся дорогой вырезкой — ресторанная толщина требует духовки. Часть туши: кострец — верх крестцовой части, за поясницей.",
  ...
  },
  {
    ...
    "hint": "Полоски постного мяса из костреца, созданные для раскалённого вока и азиатских блюд «на скорую руку». Часть туши: кострец — верх крестцовой части, за поясницей.",
  ...
  },
  {
    ...
    "hint": "Аккуратные кубики, чья судьба — маринад, шампур и открытый огонь. Часть туши: кострец — верх крестцовой части, за поясницей.",
  ...
  },
  {
    ...
    "hint": "Треугольный кусок, прославивший одно калифорнийское барбекю; резать его нужно, следя за меняющимся направлением волокон. Часть туши: нижняя часть костреца (bottom sirloin), треугольная мышца.",
    "comment": "Треугольный ростбиф из нижней части сирлойна весом около килограмма — звезда калифорнийского барбекю Санта-Мария. Готовится на гриле на непрямом жаре или в духовке до 54–57°C внутри с финальной корочкой; обязательно нарезается поперёк волокон, причём направление волокон в треугольнике меняется. От других ростбифов отличается характерной треугольной формой и относительно быстрым приготовлением.\n\nПоставка и разделка на кухне:\nПриходит уже выделенным треугольным куском (~1–1,5 кг), зачищенным или с жировой крышкой:\n• целиком — Tri-Tip Roast;\n• ломтями 2–2,5 см поперёк волокон — Tri-Tip Steak;\n• важно: волокна в треугольнике меняют направление от угла к углу — линию реза приходится разворачивать."
  },
  {
    ...
    "hint": "Порционная нарезка «треугольника» с западного побережья США; его тёзку из задней ноги путают с ним постоянно. Часть туши: нижняя часть костреца (bottom sirloin), треугольная мышца.",
  ...
  },
  {
    ...
    "hint": "Жаркое с французским аристократическим именем: самая нежная мышца туши, запечённая целиком для романтического ужина на двоих. Часть туши: вырезка — внутренняя поясничная мышца под позвоночником.",
    "comment": "Центральная часть вырезки целиком — шатобриан, самое нежное жаркое из говядины. Запекается после обжарки корочки при 200°C всего 15–25 минут до 52–54°C внутри; классическая подача — с соусом беарнез. От филе-миньона отличается тем, что это цельный кусок на двоих-четверых, а не порционный медальон; от рибай-ростбифа — почти полным отсутствием жира и максимальной нежностью.\n\nПоставка и разделка на кухне:\nПриходит целая вырезка (PSMO, 2,5–3 кг в вакууме) — единая мышца, пила не нужна:\n• снять боковую «цепочку» (chain) и серебристую плёнку;\n• толстая головная часть — Chateaubriand (жаркое на двоих) или крупные стейки;\n• ровный центр нарезается медальонами: 4–5 см — Filet Mignon, 5–6 см — Steakhouse Cut;\n• сужающийся хвост — Tenderloin Tips (бефстроганов, стир-фрай);\n• медальон, обёрнутый полоской бекона со шпажкой, — Bacon-Wrapped Filet Mignon."
  },
  {
    ...
    "hint": "Самый дорогой и нежный из классических стейков: мышца, которая при жизни быка почти не напрягалась. Часть туши: вырезка — внутренняя поясничная мышца под позвоночником.",
  ...
  },
  {
    ...
    "hint": "Высокий «бочонок» из самой нежной мышцы — визитная карточка дорогих ресторанов. Часть туши: вырезка — внутренняя поясничная мышца под позвоночником.",
  ...
  },
  {
    ...
    "hint": "Маленькие кусочки «королевской» мышцы: выглядят как гуляш, но тушить их — только портить. Часть туши: вырезка — внутренняя поясничная мышца под позвоночником.",
  ...
  },
  {
    ...
    "hint": "Самый нежный стейк, «одетый» в копчёный свиной пояс — постному аристократу одолжили немного жира. Часть туши: вырезка — внутренняя поясничная мышца под позвоночником.",
  ...
  },
  {
    ...
    "hint": "Французы зовут его «бавет»: рыхлые крупные волокна, обязательный маринад и нарезка строго поперёк — иначе не прожуёшь. Часть туши: низ костреца (bottom sirloin), пласт у пашины.",
    "comment": "Флэп-стейк (бавет) из нижней части сирлойна — рыхлый, волокнистый, с ярким говяжьим вкусом. Обязательно маринуется, жарится на сильном жаре до medium rare и нарезается тонко строго поперёк волокон — иначе будет жёстким. От фланк-стейка отличается более рыхлой, открытой структурой волокон и большей жирностью; от скёрт-стейка — большей толщиной.\n\nПоставка и разделка на кухне:\nПриходит отдельным зачищенным пластом в вакууме — резать почти нечего:\n• снять остатки мембраны и плёнок;\n• жарится ЦЕЛЫМ пластом, а нарезается уже готовым — тонко, поперёк волокон, под углом;\n• сырым можно нарезать полосами для фахитас или тонкими листами под рулетики."
  },
  {
  ...
  },
  {
    ...
    "hint": "Плоский «полосатый» кусок из живота — король фахитас; его волокна видно невооружённым глазом. Часть туши: пашина — плоская мышца низа живота.",
  ...
  },
  {
    ...
    "hint": "Длинная тонкая «лента» из-под рёбер, внутренняя из двух сестёр-диафрагм — любимица мексиканской кухни. Часть туши: внутренняя диафрагма (внутри брюшной полости, под рёбрами).",
  ...
  },
  {
    ...
    "hint": "Наружная из двух «юбок» — толще, нежнее и дороже своей внутренней сестры; шефы охотятся именно за ней. Часть туши: наружная диафрагма (снаружи рёберной стенки).",
  ...
  },
  {
    ...
    "hint": "Классика воскресного семейного ужина в США: несколько часов в жидкости — и мясо разбирается вилкой. Часть туши: лопаточно-шейная часть (чак), передняя четверть туши.",
    "comment": "Бескостное жаркое из лопаточно-шейной части (чак) — главный отруб для американского пот-роуста. Готовится только медленно: тушение в жидкости 3–4 часа при 150°C или в мультиварке 8 часов, пока коллаген не превратится в желатин и мясо не начнёт распадаться на волокна. От рибай-ростбифа отличается принципиально: запекать его до medium rare нельзя — будет жёстким, ему нужно именно долгое тушение.\n\nПоставка и разделка на кухне:\nПриходит огромный чак-ролл (бескостный лопаточно-шейный отруб, 7–10 кг в вакууме) — режется ножом:\n• первые 2–3 реза по 2,5 см с рёберного конца — Chuck Eye Steak («рибай бедняка»: та же мышца, что у рибая);\n• дальше ломти 2–2,5 см — чак-стейки; ~1 см — Thin-Sliced (бульгоги);\n• куски по 1–1,5 кг, перевязанные шпагатом, — Chuck Roast для тушения;\n• жилистые обрезки — кубиками в Beef for Stew или на фарш."
  },
  {
    ...
    "hint": "Порционный кусок из «рабочей» передней части туши: вкус богатый, цена низкая, но жилы требуют уважения. Часть туши: лопаточно-шейная часть (чак), передняя четверть туши.",
  ...
  },
  {
    ...
    "hint": "Его называют стейком «бедняка», намекая на знаменитого мраморного соседа: та же мышца, соседнее ребро, вдвое меньшая цена. Часть туши: лопаточная часть у 5-го ребра — продолжение рибайной мышцы.",
  ...
  },
  {
    ...
    "hint": "Жилистый «работяга» из передка, нарезанный тонко — так его жёсткость почти незаметна; корейцы делают из такого бульгоги. Часть туши: лопаточно-шейная часть (чак), передняя четверть туши.",
  ...
  },
  {
    ...
    "hint": "Короткие кости, на которых лежит толстая «подушка» мраморного мяса — после долгого тушения она тает, как тушёнка мечты. Часть туши: рёберная зона лопатки (короткие рёбра передней четверти).",
    "comment": "Короткие рёбра из лопаточной части — толстый слой мраморного мяса поверх коротких кусков кости. Готовятся низко и медленно: брейзинг в вине или бульоне 3 часа, копчение 6–8 часов или су-вид 48 часов; результат — тающее желатинистое мясо. От спинных рёбер (back ribs) отличаются тем, что мясо лежит толстым слоем НА кости, а не между костями; от фланкен-рёбер — нарезкой вдоль кости, а не поперёк.\n\nПоставка и разделка на кухне:\nПриходит пластина коротких рёбер лопатки (мясной пласт на 4 рёбрах) — режется ТОЛЬКО пилой:\n• пила ВДОЛЬ костей, брусками по одному ребру длиной 8–10 см, — Chuck Short Ribs (английская нарезка);\n• пила ПОПЕРЁК костей, полосами ~1 см с овальными срезами кости, — Flanken Style Ribs (гальби);\n• срезать весь мясной пласт с костей ножом — бескостные версии обоих вариантов."
  },
  {
    ...
    "hint": "Вся мраморная роскошь коротких рёбер, но грызть и обгладывать уже нечего — кость забрали. Часть туши: рёберная зона лопатки (короткие рёбра передней четверти).",
  ...
  },
  {
    ...
    "hint": "Рёбра, распиленные «неправильно» — поперёк костей: корейцы маринуют такие полосы с грушей и бросают на гриль. Часть туши: рёберная зона лопатки (короткие рёбра передней четверти).",
  ...
  },
  {
    ...
    "hint": "Длинные тонкие мраморные ленты для гриля по-корейски, из которых уже убрали все овальные косточки. Часть туши: рёберная зона лопатки (короткие рёбра передней четверти).",
  ...
  },
  {
    ...
    "hint": "Великий самозванец: формой притворяется самым нежным жарким туши, но без долгого тушения его не прожевать. Часть туши: лопатка — коническая мышца вдоль лопаточной кости.",
    "comment": "«Ложная вырезка» — мышца лопатки, по форме напоминающая настоящую вырезку, но по текстуре совсем другая: много соединительной ткани. Готовится только медленным тушением 2,5–3 часа в жидкости или в мультиварке; запекать до medium rare, как шатобриан, нельзя — будет жёстким. Главное отличие от настоящей вырезки — обманчивость: похожая коническая форма при жёсткой «рабочей» текстуре, отсюда и слово «mock» (ложный) в названии.\n\nПоставка и разделка на кухне:\nПриходит целая лопатка (shoulder clod, 8–10 кг); пила не нужна — мышцы разбирают ножом по естественным швам:\n• плоская верхняя мышца (top blade): нарезка ПОПЕРЁК по 2,5 см — Top Blade Steak с жилой по центру; разделка ВДОЛЬ с полным удалением жилы — два пласта Flat Iron;\n• коническая мышца у лопаточной кости — Mock Tender («ложная вырезка»);\n• маленькая мышца teres major — Shoulder Tender, режется медальонами по 2–3 см;\n• основной массив плеча — Shoulder Roast, стейки 2 см, тонкая нарезка и пласт 4–5 см под London Broil."
  },
  {
    ...
    "hint": "Стейк-обманщик: кругленький, как дорогой медальон, но слово в его английском названии честно предупреждает о подделке. Часть туши: лопатка — коническая мышца вдоль лопаточной кости.",
  ...
  },
  {
    ...
    "hint": "Тонкие овальные ломтики мышцы-самозванки: в таком виде её жёсткий характер почти не чувствуется. Часть туши: лопатка — коническая мышца вдоль лопаточной кости.",
  ...
  },
  {
    ...
    "hint": "Жаркое из той части, которой бык «машет» всю жизнь — постное, требует либо часов в жидкости, либо очень тонкой нарезки. Часть туши: плечевая часть лопатки.",
  ...
  },
  {
    ...
    "hint": "Постный «трудяга» из плеча: маринад, сильный огонь, нарезка поперёк волокон — только так он раскрывается. Часть туши: плечевая часть лопатки.",
  ...
  },
  {
    ...
    "hint": "Плечевой «трудяга», нарезанный тонко — минус жёсткость, плюс скорость. Часть туши: плечевая часть лопатки.",
  ...
  },
  {
    ...
    "hint": "Маленький секрет мясников: крошечная мышца из лопатки, уступающая в нежности только «королеве» стейков, но не в цене. Часть туши: лопатка — маленькая мышца teres major под лопаточной костью.",
  ...
  },
  {
    ...
    "hint": "Мини-«миньоны» из лопатки: гости не отличат от дорогой классики, а кошелёк скажет спасибо. Часть туши: лопатка — маленькая мышца teres major под лопаточной костью.",
  ...
  },
  {
    ...
    "hint": "Мраморное лопаточное жаркое с «дефектом» — жёсткой жилой посередине, которая после долгого тушения превращается в желе. Часть туши: верхняя (наружная) мышца лопатки.",
  ...
  },
  {
    ...
    "hint": "Мраморный лопаточный стейк с «линией разлома» посередине; его знаменитый брат — это он же, только без жилы. Часть туши: верхняя (наружная) мышца лопатки.",
  ...
  },
  {
    ...
    "hint": "Тонкие мраморные ломтики с едва заметной «ниточкой» посередине — в таком виде жила уже не помеха. Часть туши: верхняя (наружная) мышца лопатки.",
  ...
  },
  {
    ...
    "hint": "Назван в честь старинного утюга: плоский, мраморный, второй по нежности в туше — а всего лишь лопатка, из которой убрали одну жилу. Часть туши: верхняя (наружная) мышца лопатки.",
  ...
  },
  {
    ...
    "hint": "Кусок для блюда, названного в честь британской столицы, хотя там его никто не готовит; этот вариант — из передней части туши. Часть туши: плечевая часть лопатки.",
  ...
  },
  {
    ...
    "hint": "Постная плоская половина отруба, ради которого техасцы топят коптильни по 12 часов; из неё же делают пастрами. Часть туши: грудинка — грудь между передними ногами.",
    "comment": "Плоская часть грудинки (флэт) — постная половина брискета с ровным слоем жира сверху. Готовится только низко и медленно: копчение 10–12 часов при 110–120°C до 92–96°C внутри, брейзинг в духовке 3–4 часа, а также классика для пастрами и солонины. От жирной части грудинки (поинт) отличается постностью и ровной формой, удобной для нарезки ломтями; жарить её как стейк нельзя категорически.\n\nПоставка и разделка на кухне:\nПриходит либо целый брискет (флэт + поинт, 5–7 кг в вакууме), либо уже отделённая плоская часть:\n• ножом снять жировую крышку до слоя 0,5–1 см;\n• по жировому шву отделить плоский флэт от жирного поинта;\n• флэт готовится ЦЕЛИКОМ (копчение, брейзинг, посол на пастрами/солонину) и режется ломтями поперёк волокон уже готовым."
  },
  {
    "id": "BEEF_FOR_STEW",
    "number": 62,
    ...
    "hint": "Кубики, чьё призвание — кастрюля и долгие часы: на шампуре они мстят жёсткостью, а в гуляше становятся бархатом. Часть туши: сборные обрезки жёстких рабочих частей — лопатки и ноги.",
    "comment": "Гуляшное мясо — кубики из жёстких рабочих отрубов (обычно лопатка или нога) с большим количеством коллагена. Готовится только долгим тушением: обжарка кубиков до корочки, затем 2–3 часа томления в бульоне или вине, пока коллаген не превратится в желатин. От кубиков для кебабов отличается принципиально: жарить его быстро нельзя — будет резиновым, его сила раскрывается только в супах, гуляшах и рагу.\n\nПоставка и разделка на кухне:\nПриходит либо готовыми фабричными кубиками в лотках, либо нарезается на кухне из обрезков:\n• остатки от зачистки чак-ролла, лопатки и ноги режут кубиками 3–4 см;\n• жилы и плёнки не выбрасывают полностью — коллаген в тушении превращается в желатин;\n• это «сборный» продукт: своей анатомической формы у него нет."
  },
  {
    ...
    "hint": "Толстый постный пласт из задней ноги для «британского» блюда, которое придумали американцы: сутки в маринаде, потом под раскалённый гриль. Часть туши: внутренняя часть бедра задней ноги.",
    "comment": "Толстый плоский пласт из верхней части задней ноги для метода «лондон-бройл». Маринуется 6–24 часа (кислота в маринаде размягчает плотные волокна), жарится под грилем или на углях до строго medium rare и нарезается тонко поперёк волокон. От лопаточной версии лондон-бройла отличается происхождением из ноги: мясо постнее и плотнее; от топ-раунд-роуста — плоской формой пласта под жарку, а не запекание.\n\nПоставка и разделка на кухне:\nПриходит выделенная внутренняя часть бедра (top round, 6–8 кг в вакууме) — режется ножом:\n• целый кусок или половина — Top Round Roast (ростбиф под тонкую нарезку на слайсере);\n• плоский пласт 4–5 см — Top Round London Broil;\n• ломти 2 см — стейки; 0,5–1 см — Thin-Sliced (руладены, сэндвичи);\n• полоски 5×1 см — for Stir Fry."
  },
  {
    "id": "TOP_ROUND_ROAST",
    "number": 64,
    ...
    "hint": "Именно из него делают то самое тонко нарезанное розовое мясо для деликатесных сэндвичей — постный ростбиф из ноги. Часть туши: внутренняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Постный и упрямый стейк из самой «ходовой» части туши — без маринада и правильной нарезки поперёк волокон с ним не подружиться. Часть туши: внутренняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Тонкие постные листы из ноги — немцы заворачивают в такие огурчик с горчицей и тушат рулетики. Часть туши: внутренняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Бюджетные полоски из ноги для вока: без «бархатного» крахмального маринада по-китайски их лучше даже не начинать жарить. Часть туши: внутренняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Жёсткий постный кусок из внешней стороны ноги — немцы неделю вымачивают его в уксусе ради своего знаменитого кисло-сладкого жаркого. Часть туши: внешняя часть бедра задней ноги.",
    "comment": "Ростбиф из нижней (внешней) части задней ноги — плотный, постный, с грубым волокном. Два пути: медленное запекание до medium rare с бритвенно-тонкой нарезкой либо тушение 3 часа; также классическая основа для немецкого зауэрбратена (маринование в уксусе несколько дней). От топ-раунда отличается большей жёсткостью, от рамп-роуста — соседним расположением, их часто продают под общим именем.\n\nПоставка и разделка на кухне:\nПриходит внешняя часть бедра (bottom round flat / rump, 4–6 кг в вакууме):\n• куски по 1,5–2 кг — Bottom Round Roast и Rump Roast (огузок — конец у крестца);\n• ломти 2 см — стейки (под отбивание/маринад); ~0,5 см — Thin-Sliced;\n• ломоть, прогнанный через тендерайзер, — Beef Cubed Steak;\n• обрезки — Round Chunks для тушения."
  },
  {
    "id": "RUMP_ROAST",
    "number": 69,
    ...
    "hint": "Жаркое с «пятой точки» туши — в русской кухне эту часть зовут огузком и любят за навар в тушёных блюдах. Часть туши: верх задней ноги у крестца (огузок).",
  ...
  },
  {
    ...
    "hint": "Самый суровый из «ножных» стейков: молоток для отбивания и час в томатном соусе — его лучшие друзья. Часть туши: внешняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Жёсткий боец из ноги, нарезанный почти прозрачно — в горячем бульоне такие ломтики готовятся за секунды. Часть туши: внешняя часть бедра задней ноги.",
  ...
  },
  {
    ...
    "hint": "Ровные кругляши из ноги, косящие под дорогие медальоны — но их «глаз» не имеет ничего общего с мраморным тёзкой из передней части. Часть туши: глазной мускул — центральная цилиндрическая мышца внешней части бедра.",
  ...
  },
  {
    ...
    "hint": "Тонкие постные кругляши: латиноамериканцы панируют такие и жарят до хруста — получается миланеза. Часть туши: глазной мускул — центральная цилиндрическая мышца внешней части бедра.",
  ...
  },
  {
    ...
    "hint": "Его название нагло врёт: слово «сирлойн» в нём есть, а сам он — из ноги; постное жаркое для тонкой нарезки. Часть туши: передняя часть бедра над коленом («орех» ноги).",
    "comment": "Ростбиф из «кончика сирлойна» — несмотря на название, это часть ноги (knuckle), а не сирлойна. Постный и умеренно жёсткий: медленно запекается при 120–135°C до 52–55°C с тонкой нарезкой либо тушится. От настоящих сирлойн-отрубов отличается происхождением из ноги и меньшей нежностью — название исторически вводит покупателей в заблуждение; от три-тип-роуста — формой и текстурой.\n\nПоставка и разделка на кухне:\nПриходит целый «орех» ноги (knuckle / sirloin tip, 4–5 кг); плёнки снимают ножом, мышцы делят по швам:\n• крупные куски — Sirloin Tip Roast;\n• центральная мышца ломтями 2 см — Sirloin Tip Steak, боковая — Sirloin Tip Side Steak;\n• ~1 см — Thin-Sliced обеих мышц (сэндвичи, фахитас, стир-фрай)."
  },
  {
    ...
    "hint": "Боковой срез мышцы-обманщицы из ноги, которая лишь называется в честь костреца. Часть туши: передняя часть бедра над коленом («орех» ноги).",
  ...
  },
  {
    ...
    "hint": "Бюджетный постный стейк с обманчивым именем: к настоящему кострецу отношения не имеет, а с «треугольным» тёзкой их путают даже продавцы. Часть туши: передняя часть бедра над коленом («орех» ноги).",
  ...
  },
  {
    ...
    "hint": "Тонкие ломтики бокового среза «ложного сирлойна» из ноги — быстрая жарка и сразу на стол. Часть туши: передняя часть бедра над коленом («орех» ноги).",
  ...
  },
  {
    ...
    "hint": "Тонкие постные ломтики мышцы, которая «прикидывается» кострецом — дешёвая рабочая лошадка для сэндвичей. Часть туши: передняя часть бедра над коленом («орех» ноги).",
  ...
  },
  {
    ...
    "hint": "Его уже «избила» специальная машина: узор из квадратиков на поверхности выдаёт его с головой; южане панируют его и жарят, как курицу. Часть туши: задняя нога или лопатка (жёсткие постные ломти).",
    "comment": "Кубед-стейк — кусок из ноги или лопатки, механически размягчённый тендерайзером: на поверхности видны характерные квадратные насечки-«кубики». Классика для жареного стейка по-деревенски (chicken fried steak): панировка и жарка 3–4 минуты на сторону, либо быстрое тушение в подливе. От обычного раунд-стейка отличается тем, что уже отбит машиной; название происходит от узора насечек, а не от формы куска.\n\nПоставка и разделка на кухне:\nПриходит либо готовыми отбитыми порциями, либо делается на кухне:\n• ломоть раунда или лопатки толщиной 1,5–2 см прогоняют через механический тендерайзер (машину с игольчатыми ножами) один-два раза;\n• характерная сетка квадратных насечек на поверхности — след машины, отсюда и название."
  },
  {
    "id": "BEEF_SHANK",
    "number": 82,
    ...
    "hint": "Поперечный «спил» ноги с косточкой-колечком в центре: миланцы тушат его часами и назвали блюдо в честь «кости с дыркой». Часть туши: голяшка — нога ниже колена, вокруг мозговой кости.",
    "comment": "Голяшка — поперечный срез ноги с мозговой костью в центре и очень жилистым мясом вокруг. Готовится только долгим тушением 3–4 часа: классика — оссобуко по-милански и наваристые бульоны; коллаген превращается в желатин, а костный мозг обогащает соус. От любого стейка отличается кардинально: жарить голяшку бессмысленно, зато для холодца и бульона ей нет равных.\n\nПоставка и разделка на кухне:\nПриходит целая голяшка с костью — режется ТОЛЬКО ленточной пилой:\n• пила поперёк кости на «шайбы» 4–5 см — классические стейки для оссобуко;\n• тонкие крайние срезы и обрезь — в бульон, холодец или фарш."
  },
  {
    "id": "FRESH_BEEF_HEART",
    "number": 83,
